...
public static class ArtifactTools
{
    ...
    public static string SafeFilename(string name, string fallback = "download")
    {
    ...
    public static string UniqueFilePath(string directory, string name, string suffix)
    {
        ...
        return Path.Combine(directory, safe + "_" + Environment.ProcessId + suffix);
    }
    ...
    public static string UniqueDirectoryPath(string directory, string name)
    {
        ...
        return Path.Combine(directory, safe + "_" + Environment.ProcessId);
    }
